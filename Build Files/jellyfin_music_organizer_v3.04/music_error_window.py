...
class MusicErrorWindow(QMainWindow):
    ...
    def setup_titlebar(self):
        ...
        titlebar_widget = QWidget(self)
        self.setCentralWidget(titlebar_widget)
        vbox_titlebar_layout = QVBoxLayout(titlebar_widget)
        ...
        vbox_titlebar_layout.addWidget(self.title_bar, 0, Qt.AlignTop)
